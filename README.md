...
- **Zod** — runtime validation of every persisted record, schema-versioned migrations (v1 → v11)
...
Migrations (v1→v11, field-by-field salvage on corruption)
   │  validate
...
- [x] Schema-versioned migrations (v1 → v11) with corruption salvage
